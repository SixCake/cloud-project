package com.sixcake.cloud.auth.config;

import com.sixcake.cloud.auth.domain.dto.ResourceRoleRelationDto;
import com.sixcake.cloud.auth.service.ResourceService;
